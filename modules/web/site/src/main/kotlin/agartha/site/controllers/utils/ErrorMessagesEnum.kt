...
enum class ErrorMessagesEnum(val message: String){
    ...
    DISCIPLINE_INTENTION_EMPTY("Discipline and Intention cannot be empty"),
    ...
    IMAGE_MISSING("Image missing or not of type jpg, jpeg or png");

    /**
     * Get the Error message as json String
     */
