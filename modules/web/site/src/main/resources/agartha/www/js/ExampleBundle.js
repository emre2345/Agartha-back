...
/******/ 	return __webpack_require__(__webpack_require__.s = "./www/ts/ExampleLoader.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var PractitionerReport_1 = __webpack_require__(/*! ./objects/PractitionerReport */ "./www/ts/objects/PractitionerReport.ts");
var GeolocationInfo_1 = __webpack_require__(/*! ./objects/GeolocationInfo */ "./www/ts/objects/GeolocationInfo.ts");
new vue_1.default({
    el: "#main",
    template: "\n    <div id=\"main\">\n        <h3>Links section</h3>\n        <ul class=\"container\">\n            <li>\n                <a href=\"companions.html\"> Step 1: Companions (What happened last couple of days) </a>\n           </li>\n           <li>\n                <a href=\"practice.html\"> Step 2: Discipline  (Practitioner selects Discipline) </a>\n            </li>\n            <li>\n                <a href=\"contribution.html\"> Step 3: Contribution (Practitioner selects Intention) </a>\n            </li>\n            <li>\n                <a href=\"prepare.html\"> Step 4: Prepare (Practitioner starts session) </a>\n             </li>\n             <li>\n                <a href=\"ongoingSession.html\"> Step 5: Ongoing Session (Practitioner has a ongoing session) </a>\n            </li>\n             <li>\n                <a href=\"confirmation.html\"> Step 6: Confirmation (Session feedback) </a>\n            </li>\n            <li>\n                <a href=\"contact.html\"> Step 7: Contact (Get involved) </a>    \n            </li>\n        </ul>\n\n        <h3>Debug section</h3>\n        <div class=\"container\">\n            <div><b>Browser info:</b> {{userAgent}}</div>\n            <div><b>All Disciplines:</b> {{ disciplines ? JSON.stringify(disciplines) : \"not loaded\" }}</div>\n            <div><b>All Intentions:</b> {{ intentions ? JSON.stringify(intentions) : \"not loaded\" }}</div>\n            <hr/>\n            <div><b>Selected Discipline:</b> {{ selectedDiscipline ? selectedDiscipline.title : \"none selected\" }}</div> \n            <div><b>Selected Intention:</b> {{ selectedIntention ? selectedIntention.title : \"none selected\" }}</div> \n            <div>Current user id: {{ user ? user.practitionerId : \"N/A\" }}</div>   \n        </div>\n        <h3>Repopulate</h3>\n         <div class=\"container\">\n            <button @click=\"repop\">Repopulate DB and clear selections</button> \n        </div>\n    </div>",
    data: function () {
        return {
            ...
            disciplines: [],
            intentions: [],
            selectedDiscipline: StorageUtil_1.StorageUtil.mSelectedDisciplineService.get(),
            selectedIntention: StorageUtil_1.StorageUtil.mSelectedIntentionService.get()
        };
    },
    created: function () {
        var _this = this;
        ...
        var params = this.user ? [this.user.practitionerId] : [];
        ...
        var practitionerRequest = new Request_1.default(RequestInformation_1.REQUEST_PRACTITIONER, params, function (response) {
            _this.user = response;
            StorageUtil_1.StorageUtil.mPractitionerService.set(response);
        });
        var companionRequest = new Request_1.default(RequestInformation_1.REQUEST_COMPANION_ONGOING, params, function (response) {
            StorageUtil_1.StorageUtil.mCompanionService.set(response);
        });
        new ServerCaller_1.default([settingsRequest, practitionerRequest, companionRequest]).callServer();
    },
    methods: {
        repop: function () {
            var _this = this;
            localStorage.clear();
            var repopRequest = new Request_1.default(RequestInformation_1.REQUEST_REPOPULATE, [], function (data) {
                _this.user = new PractitionerReport_1.default(data.id, 0, 0, false);
                StorageUtil_1.StorageUtil.mPractitionerService.set(_this.user);
            });
            var settingsRequest = new Request_1.default(RequestInformation_1.REQUEST_SETTINGS, [], function (settings) {
                _this.setSettings(settings);
                _this.selectedDiscipline = null;
                _this.selectedIntention = null;
            });
            new ServerCaller_1.default([repopRequest, settingsRequest]).callServer();
        },
        setSettings: function (settings) {
            StorageUtil_1.StorageUtil.mSettingsService.set(settings);
            this.intentions = settings.intentions;
            this.disciplines = settings.disciplines;
        }
    }
});
...
/***/ "./www/ts/objects/PractitionerReport.ts":
/*!**********************************************!*\
  !*** ./www/ts/objects/PractitionerReport.ts ***!
  \**********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var PractitionerReport = (function () {
    function PractitionerReport(practitionerId, lastSessionMinutes, totalSessionMinutes, involved) {
        this.practitionerId = practitionerId;
        this.lastSessionMinutes = lastSessionMinutes;
        this.totalSessionMinutes = totalSessionMinutes;
        this.involved = involved;
    }
    return PractitionerReport;
}());
exports.default = PractitionerReport;
