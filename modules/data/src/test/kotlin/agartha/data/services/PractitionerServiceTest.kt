...
class PractitionerServiceTest : DatabaseHandler() {
    ...
    fun practitionerService_insertSessionIndexReturned_1() {
        ...
        // Insert session
        val sessionId = PractitionerService().startSession(item._id as String, "Test")
    ...
    fun practitionerService_insertSessionCount_3() {
        ...
        val item = PractitionerService().insert(user)
        // Insert sessions
        PractitionerService().startSession(item._id as String, "Test 1")
        PractitionerService().startSession(item._id as String, "Test 2")
        PractitionerService().startSession(item._id as String, "Test 3")
